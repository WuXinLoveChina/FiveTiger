...
public class NetManager : MonoBehaviour
{
    ...
    public static void SendUserLogin(LoginData.LoginRet retFun, bool bForce, bool bReconnect = false)
    {
        ...
        accountInfo.SetDeviceid(SystemInfo.deviceUniqueIdentifier);
        accountInfo.SetDevicetype(SystemInfo.deviceType.ToString() + "_" + SystemInfo.deviceName);
        accountInfo.SetDeviceversion(SystemInfo.graphicsDeviceVersion);

        accountInfo.SetAccount("cdc6d50");
